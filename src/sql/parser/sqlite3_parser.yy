...
between_expr:
	expr BETWEEN expr AND expr %prec BETWEEN	{ $$ = $1 + " BETWEEN " + $3 + " AND " + $5; }		// TODO Solve reduce/reduce conflict for these two
	| expr NOT BETWEEN expr AND expr %prec BETWEEN	{ $$ = $1 + " NOT BETWEEN " + $4 + " AND " + $6; }
	;
...
columnconstraint:
	...
	| optional_constraintname REFERENCES id optional_columnid_with_paren_list optional_fk_clause	{	// TODO Solve shift/reduce conflict. It is not super important though as shifting seems to be right here.
...
tableconstraint:
	...
	| optional_constraintname FOREIGN KEY "(" columnid_list ")" REFERENCES id optional_columnid_with_paren_list optional_fk_clause	{

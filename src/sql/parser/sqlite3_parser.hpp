  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_CONSTRAINT = 295,
        TOK_CREATE = 296,
        TOK_CURRENT_DATE = 297,
        TOK_CURRENT_TIME = 298,
        TOK_CURRENT_TIMESTAMP = 299,
        TOK_DEFAULT = 300,
        TOK_DEFERRABLE = 301,
        TOK_DEFERRED = 302,
        TOK_DELETE = 303,
        ...
        TOK_IDENTIFIER = 362,
        TOK_NUMERIC = 363,
        TOK_STRINGLITERAL = 364,
        TOK_QUOTEDLITERAL = 365,
        TOK_BLOBLITERAL = 366,
        TOK_BINDPARAMETER = 367
      };
    };
...
switch (yytype)
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 2380,     ///< Last index in yytable_.
  ...
  parser::yytranslate_ (token_type t)
  {
    ...
    const unsigned user_token_number_max_ = 367;
